...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests() // 認可に関する設定
			...
			.antMatchers("/","/showItemDetail","/showCartList","/toLoginPage","/registerUser","/showRegisterUserPage","/insertOrderItem","/deleteOrder","/toLoginPageError","/deleteOrder2").permitAll() //「/」などのパスは全てのユーザに許可
